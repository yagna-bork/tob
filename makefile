...
EXTERNAL_INCLUDES=-I/usr/local/opt/protobuf/include -I/usr/local/opt/abseil/include -I/usr/local/opt/proj/include \
				  -I/usr/local/opt/nlohmann-json -I/usr/local/opt/curl/include -I/usr/local/opt/sqlite/include \
				  -I/usr/local/opt/cpp-httplib/include
...
obj/server.o: $(INCLUDE_FILES)
	g++ $(EXTERNAL_INCLUDES) -c -o obj/server.o $(CXX_STD) server.cpp 
...
obj/vector_tile_pb.o: tiles/vector_tile.pb.cc
	g++ -c -o obj/vector_tile_pb.o tiles/vector_tile.pb.cc $(CXX_STD) $(EXTERNAL_INCLUDES)

obj/vector_tile_test.o: tiles/vector_tile_test.cpp include/vector_tile.pb.h include/util.h
	g++ -c -o obj/vector_tile_test.o tiles/vector_tile_test.cpp $(CXX_STD) $(EXTERNAL_INCLUDES)
